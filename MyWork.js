            ...
            <div className="p-4 slide-in-top">
                ...
                <div className="row">
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls1" className="carousel slide my-1" data-bs-ride="carousel">
                            <div className="carousel-inner">
                                ...
                                <img src="../portfolio-images/portfolio.jpeg" className="d-block w-100" alt="..."/>
                                </div>
                            ...
                            <h5 className="ff-jose my-1">portfolio Website</h5>
                            <div className="row d-flex justify-content-center">
                                <a href="https://github.com/vipranshu/portfolio-website.git" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" target="_blank"><BsLaptop/> Watch Live</a>
                                <a href="https://github.com/vipranshu/portfolio-website.git" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" target="_blank"><AiFillGithub/> Source Code</a>
                            </div>
                    ...
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div>
                            <h5 className="ff-jose my-1">Movieshunt Project</h5>
                            <div className="row d-flex justify-content-center">
